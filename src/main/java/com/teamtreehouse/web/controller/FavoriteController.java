...
public class FavoriteController {
    ...
    @PreAuthorize("hasRole('ROLE_USER')") //Pre-Ensure user has the ROLE_USER role before executing URI request
    ...
    //Action to take when FavoriteNotFoundException exception is thrown
    ...
    //Action to take when FavoriteSaveException exception or FavoriteDeleteException exception is thrown
