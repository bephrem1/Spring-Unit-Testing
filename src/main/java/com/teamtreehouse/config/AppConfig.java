...
public class AppConfig extends WebMvcConfigurerAdapter {
    ...
    private ClientHttpRequestFactory clientHttpRequestFactory() {
        ...
        factory.setReadTimeout(timeout); //Setting Timeout values for fetching data from API
        factory.setConnectTimeout(timeout); //Setting Timeout values for fetching data from API
        return factory;
    }
